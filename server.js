...
app.get('/services/tree_removal', (req, res) => res.render('tree_removal', {active_page: 'tree_removal'}));
app.get('/services/stump_grinding', (req, res) => res.render('stump_grinding', {active_page: 'stump_grinding'}));
app.get('/services/firewood', (req, res) => res.render('firewood', {active_page: 'firewood'}));
app.get('/services/hardscape', (req, res) => res.render('hardscape', {active_page: 'hardscape'}));
